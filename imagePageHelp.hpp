...
QString transparentText = 
  imagePage::tr ("Selecting this option will cause all empty cells to be set to transparent (alpha channel) in the "
...
QString carisText = 
  imagePage::tr ("This check box will force the output to be unblocked and use <b>PACKBITS</b> compression "
                 ...
                 "not an NFS mounted disk (/net/whatever).");
